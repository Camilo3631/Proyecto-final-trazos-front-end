            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
               {citasProximas.map((cita) => (
                 <div key={cita._id} className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition transform hover:scale-105">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {citasFinalizadas.map((cita) => (
                      <div key={cita._} className="bg-slate-100 rounded-2xl shadow-lg p-6 border-l-4 border-orange-400">
                        <div className="flex items-start gap-3 mb-4">
                        ...
                        <div className="border-t pt-4 space-y-2 text-sm text-gray-600">
                          ...
                          <p className="flrx items-center gap-2">
              ...
              <div className="fixed inset-0 bg-slate-700 bg-opacity-50 flex items-center justify-center p-4 z-50">
                <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
                  ...
                  <div className="mb-6 p-4 bg-blue-50 rounded-2xl border-l-4 border-blue-500">
                    ...
                    <p className="text-slate-700 sm-1">
